...
//Custom Definition
const char *title = "Final Project 107062313";
const float FPS = 60;
const int WIDTH = 400;
...
void game_init() {
    ...
    al_set_window_position(display, 450, 30);
...
void game_begin() {
    ...
    // Load and draw text
    font = al_load_ttf_font("pirulen.ttf",18,0);

    al_draw_text(font, al_map_rgb(0,0,0), WIDTH/2, HEIGHT/2+20 , ALLEGRO_ALIGN_CENTRE, "Press 'Space' to start");
    al_draw_rectangle(WIDTH/2-156, 310, WIDTH/2+156, 350, al_map_rgb(255, 255, 255), 0);
    al_draw_rectangle(WIDTH/2-164, 300, WIDTH/2+164, 360, al_map_rgb(255, 255, 255), 0);
